...
function GameCard({ teamA, teamB }: GameCardProps) {
    ...
    const teamAGradient = teamAWon
        ? { bgGradient: 'to-r', gradientFrom: 'green.50', gradientTo: 'transparent' }
        : {};

    const teamBGradient = teamBWon
        ? { bgGradient: 'to-l', gradientFrom: 'green.50', gradientTo: 'transparent' }
        : {};

    return (
        <Box borderBottomWidth="1px" borderColor="gray.200" _last={{ borderBottomWidth: 0 }}>
            <Flex align="center" gap={3}>
                <VStack align="flex-start" flex="1" gap={0} px={4} py={2} borderRadius="md" {...teamAGradient}>
                ...
                <VStack align="flex-end" flex="1" gap={0} px={4} py={2} borderRadius="md" {...teamBGradient}>
