...
const dummyData: { id: number; state: CourtSlotState; label: string }[] = [
    { id: 1, state: 'reserved', label: '7:00 AM' },
    { id: 2, state: 'available', label: '8:00 AM' },
    { id: 3, state: 'available', label: '9:00 AM' },
    { id: 4, state: 'available', label: '10:00 AM' },
    { id: 5, state: 'reserved', label: '11:00 AM' },
    { id: 6, state: 'reserved', label: '12:00 PM' },
    { id: 7, state: 'available', label: '1:00 PM' },
    { id: 8, state: 'available', label: '2:00 PM' },
    { id: 9, state: 'selected', label: '3:00 PM' },
    { id: 10, state: 'available', label: '4:00 PM' },
    { id: 11, state: 'available', label: '5:00 PM' },
    { id: 12, state: 'available', label: '6:00 PM' },
    { id: 13, state: 'reserved', label: '7:00 PM' },
    { id: 14, state: 'reserved', label: '8:00 PM' },
    { id: 15, state: 'reserved', label: '9:00 PM' },
